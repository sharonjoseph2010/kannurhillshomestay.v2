...
export const PearlNestHero = ({ images, openLightbox }) => {
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary-foreground">
              Homestay in Sreekandapuram, Kerala
            </span>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 text-primary-foreground/90">
              ...
              <span className="text-sm">Hill Town Stay</span>
            </div>
            <div className="flex items-center gap-2 text-primary-foreground/90">
              <Leaf className="w-4 h-4" />
              <span className="text-sm">Peaceful Location</span>
            </div>
          </motion.div>
